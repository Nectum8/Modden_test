![Example-Logo](https://sappcoin.com/wp-content/uploads/2021/05/Modden-logo-transparent.png)
...
```
wget -q https://raw.githubusercontent.com/ModdenBF/Modden/master/contrib/masternodesetup/masternodesetup.sh && sudo chmod +x masternodesetup.sh
```
